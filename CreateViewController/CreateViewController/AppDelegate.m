...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    //以前我们将UIView直接添加到UIWindow上(不好)
    //现在我们将ViewController添加到UIWindow(推荐)
    /*
    ...
    */
    ...
    //nib创建1
    /*
    RootViewController *rootViewController = [[RootViewController alloc] initWithNibName:@"View" bundle:nil]; //1
    self.window.rootViewController = rootViewController; //2
    [rootViewController release];
     */
